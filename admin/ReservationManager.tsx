...
const ReservationManager: React.FC = () => {
  ...
  return (
    <div className="space-y-8">
      <h1 className="text-xl lg:text-2xl font-bold serif text-gold">Table Reservations</h1>

      <div className="bg-black/40 border border-white/5 overflow-hidden rounded-sm">
